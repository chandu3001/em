...
$(function () {
                                 ...
                                 <div class="drodown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                       <ul class="link-list-opt no-bdr">
											...
											${item.deleted_status ? '' : `
									   		<li><a href="${formUrl('school/examination/relevant_questions?id=' + item.id)}"><em class='icon'><span class="iconify" data-icon="mdi:file-question-outline"></span></em><span class="possible-que">Possible Questions</span></a></li>
	...
	$('#form_clear').click(function (e) {
		$('#stat').select2('val', '0');
		$('#license_filters').select2('val', '0');
		$('#sub_licence_filter').select2('val', '0');
		$('#sub_licence_filter').html('')
		$('#filter-form')[0].reset();
		filters = '';
	...
	$("#btn-add-examination").click(function () {
		...
		if (langCode == 2) {
			examinationModalElm.find(".modal-header .modal-title").html("اضافة اختبار");
			addTitle = "اضافة";
	...
	$(elmExamination).on("click", ".btn-edit-examination", function (e) {
		...
		$.ajax({
			...
			if (response.status == true) {
				...
				examinationModalElm.find(".modal-header .modal-title").html(editTitle).addClass('edit-exam')
					.removeClass('add-exam');
				getLicenseList("#licencee", examinationDetail.licence_id);
