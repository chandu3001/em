$(function () {
    ...
    let langCode = localStorage.getItem('language-type');
                ...
                if (target) {
                    ...
                    data.result.forEach((item) => {
                        ...
                        $(target).append(`<div class="custom-control custom-radio me-2" onclick="genderIs();">
                            ...
                            <label class="custom-control-label" for=${item.id == 1 ? "reg-male" : "reg-female"}>${item.name}</label>
                    ...
                    $("#studentList").append(
                        ...
                        <div class="nk-tb-item details">
                            ...
                            ? `<button title="Student is Activated" type="button"
                                    ...
                                    data-student="${item.id}" data-status="${item.status}" style="background:#1abe92;border:none; padding: 5px 17px">Active</button>`
                            ...
                            : `<button title="Student is Deactivated" type="button"
                                    ...
                                    class="btn btn-sm details btn-dm btn-danger btn-change-status inactive-btn inactive_padding"
                                        ...
                                        data-student="${item.id}" data-status="${item.status}">Inactive</button>`
                                            ...
                                            <ul class="link-list-opt no-bdr">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="javascript:void(0)" class="btn-delete-student" data-student="${item.id}">
                                                        ...
                                                        <em class="icon ni ni-trash"></em><span class="delete">Delete</span>
    ...
    $("#studentList").on('click', '.btn-change-status', function (e) {
        ...
        Swal.fire({
            ...
            title: "Are you sure you want to " + (status == "1" ? "Inactive" : "Active"),
    ...
    $("#btn-add-student").click(function () {
        ...
        studentModalElm.find(".modal-body .modal-title").html(addTitle);
