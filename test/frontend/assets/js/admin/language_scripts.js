         ...
         $('head').append(`link[href="${arabicCss}"]`);
            ...
            if (status) {
              ...
              $('.total-marks').text(data['School Admin']['Report page']['Total Marks']);
               ...
               $('#select2-license_filter-container .select2-selection__placeholder,.select2-selection #select2-license_filter-container,#select2-license_filter-container .select2-selection__placeholder').text(data['Super Admin']['others']['Select License Type']);
