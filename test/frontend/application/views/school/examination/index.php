...
<body class="nk-body npc-crypto bg-lighter has-sidebar " >
            ...
            <div class="modal-body">
               ...
               <div class="mb-3">
                  ...
                  <div class="form-control-wrap inner">
                     <select  id="licence" class="form-select js-select2" data-placeholder="Select License Type" name="licence_id" required data-msg="License type is required">
               ...
               <div class="mb-3">
                  ...
                  <div class="form-control-wrap inner">
                     <select id="sub_licence" class="form-select js-select2" data-placeholder="Select Sub License Type" name="sub_license_id" data-msg="Sub License type is required">
   ...
   function getFilterLicenseList() {
      $.ajax({
         ...
         if (!errors) {
            $("#license_filter").html(`<option value=""></option>`);
