...
<body class="nk-body npc-crypto bg-lighter has-sidebar " >
                     ...
                     <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                           <div class="nk-block-head-content">
                              <h3 class="nk-block-title page-title license-types" style="margin-bottom:-5px;">License Types</h3>
                     ...
                     <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                           <div class="card-inner-group">
                                                         ...
                                                         <div class="dropdown">
                                                            ...
                                                            <form id="filter-form">
                                                               ...
                                                               <div class="dropdown-foot between">
                                                                  <a class="clickable" href="javascript:void(0)" id="clear-filter" >Clear Filters</a></div>
                                                            </form>
                                                            </div>
                                                         </div>
                                                      </li>
                              ...
                              <div class="card-inner p-0 text-center" id="licenses-container"></div>
   ...
   <script src="<?php echo base_url('assets/js/school/license.js'); ?>"></script>
