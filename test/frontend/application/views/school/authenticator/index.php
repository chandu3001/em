                                                         ...
                                                         <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-xs dropdown-menu-end">
                                                               <ul class="link-check">
                                                                  ...
                                                                  <li ><a href="javascript:void(0)" style="justify-content: space-between;">10 <input onchange="getAuthList(1,{page_size:10})"  type="checkbox"  class="radio" value="1" name="fooby[1][]"  ></a></li>
         ...
         $.ajax({
            ...
            if(status)
            {
               ...
               if(data.total > 0)
               {
                  ...
                  if(langCode == 2){
                    $('.auth-detail-list div span').text('');
                  }
                                    ...
                                    <div class="drodown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-end">
                                          <ul class="link-list-opt no-bdr">
                                             <li><a onclick="authDel(${item.id})"><em class="icon ni ni-archive"></em><span class="delete">Delete</span></a></li>
                                          </ul>
                                       </div>
                                    </div>
                                 </li>
