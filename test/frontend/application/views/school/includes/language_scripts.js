        ...
        $.ajax({
            ...
            if (status) {
              ...
              // $('.family-add').text(data['School Admin']['Families page']['Add Family']);
               ...
               $('label[for="enableCustomDates"]').text(data['School Admin']['others']['Custom Dates']);
              ...
              $('#stud-perf').text(data['School Admin']['others']['Student Performance']);
               $('.subtitle').text(data['School Admin']['others']['This Month']);
               ...
               $('#select2-licence-container .select2-selection__placeholder,#select2-license_filter-container .select2-selection__placeholder,.select2-selection #select2-license_filter-container').text(data['Super Admin']['others']['Select License Type']);
               $('#select2-sub_licence-container .select2-selection__placeholder,#select2-sub_licence_filter-container .select2-selection__placeholder,#select2-sub-license-filter-container .select2-selection__placeholder').text(data['School Admin']['Examination']['Select sublicense type']);
