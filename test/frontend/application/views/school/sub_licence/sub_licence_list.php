  <?php include_once APPPATH . 'views/school/includes/header.php'; ?>
                        ...
                        <div class="nk-block-head nk-block-head-sm">
                           <div class="nk-block-between">
                              <div class="nk-block-head-content">
                                 <h3 class="nk-block-title page-title sub-license-types" style="margin-bottom:-5px;">Sub License Types</h3>
                                       ...
                                       <div class="card-tools">
                                          <div class="form-inline flex-nowrap gx-3">
                                             <div class="form-wrap w-150px">
                                                <select id="sortby" class="form-select form-select-sm js-select2" data-search="off" data-placeholder="Sort By">
                                                         ...
                                                         <li>
                                                            <div class="dropdown">
                                                             ...
                                                             <form id="filter-form">
                                                                     ...
                                                                     <div class="row gx-6 gy-3">
                                                                        ...
                                                                        <div class="col-12">
                                                                           <div class="form-group">
                                                                              ...
                                                                              <select name='registration_status' class="form-select form-select-sm js-select2" id="stat" data-placeholder="Status">
                                                                                 <option value=""></option>
                                                                  ...
                                                                  <a href="javascript:void(0)" class="clickable" id="clear-filter">Clear Filters</a></div>
                                                            </form>
   ...
   <script src="<?php echo base_url('assets/js/school/sub_license.js'); ?>"></script>
