                                ...
                                <form id="reset-password-form" class="is-alter">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-lg" id="password" placeholder="Enter Password" required data-msg="Email is required" data-msg-password="Specify valid Password"/>
            ...
            if ($('#reset-password-form').valid()) {
                $.ajax({
                    ...
                    if(status){
                        ...
                        setTimeout(function(){location.href=domain_path+"admin/login"} , 5000);  
                    } 
                    else{
