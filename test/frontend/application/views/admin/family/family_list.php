...
<body class="nk-body npc-crypto bg-lighter has-sidebar " >
                     ...
                     <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                           <div class="nk-block-head-content">
                              <h3 class="nk-block-title page-title ftitle" data-translate>Groups</h3>
                     ...
                     <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                           <div class="card-inner-group">
                                                                     ...
                                                                     <div class="col-6">
                                                                        <div class="form-group">
                                                                          <label class="overline-title overline-title-alt status-label" data-translate>Status</label>
                                                                           <select name="status" class="form-select form-select-sm js-select2 " data-placeholder="Select Status" id="status">
                                                                              <option value=""></option>
                              ...
                              <div class="card-inner p-0 text-center" id="families"></div>
   ...
   <script src="<?php echo base_url('assets/js/admin/family.js'); ?>"></script>
