                        ...
                        <div class="nk-block-between">
                           <div
                              ...
                              <div class="d-flex justify-content-center align-items-center flex-column">
                               ...
                               <div class="d-flex justify-content-center align-items-center flex-column">
                                 <div class="fs-6 fw-bold mb-2 sub-name" data-translate>Sub Licence Type</div>
                              ...
                              <div class="drodown">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="link-list-opt no-bdr">
                                       <li><a href="${formUrl('admin/schools/answersheet?id='+item.id)}"><em class="icon ni ni-eye"></em><span>View Results</span></a></li>
