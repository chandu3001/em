                     ...
                     <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                           <div class="card-inner-group exam_details_align">
                              ...
                              <div class="card-inner p-0" id="examinations_list"></div>
  ...
  if ($box.is(":checked")) {
               ...
               if(data.data.length > 0)
               {
                  ...
                  <div class="list-area nk-tb-list nk-tb-ulist exam-detail-list">
                     <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col " id="heading_center"><span class="text-black fw-bold license-type" data-translate>Licence Type</span></div>
                        <div class="nk-tb-col" id="heading_center"><span class="text-black fw-bold sub-name" data-translate data-translate="Sub Licence Type">Sub Licence Type</span></div>
                     ...
                     $("#examinations_list .list-area").append(
                        `<div class="nk-tb-item details">    
                           ...
                           <div class="nk-tb-col">
                            ...
                            <div style="width:15%" class="nk-tb-col" id="status_button_alignment"><span class='badge badge-dim ${item.status == 1 ? 'bg-success' : 'bg-danger'}'>${item.status == 1 ? 'Active' : 'Inactive'}</span></div>
   ...
   const getSubLicenseList = (license_id) => {
      ...
      $.ajax({
         ...
         if (status) {
            $('#sub_license_filter').html(`<option value="">Select Sub License</option>`).prop('disabled', false);;
            if(data.length > 0)
            {
