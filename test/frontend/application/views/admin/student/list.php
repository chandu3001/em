                                                                     ...
                                                                     <div class="row gx-6 gy-3">
                                                                        <div class="col-12">
                                                                           <div class="form-group">
                                                                              <label
                                                                                 class="overline-title overline-title-alt" data-translate>School                                                                                 </label>
            ...
            if(status)
            {
               ...
               data.data.forEach(item => {
                  ...
                  <div class="nk-tb-item">
                     ...
                     <div style="width:15%" class="nk-tb-col"><span class='badge badge-dim ${item.status == 1 ? 'bg-success active-btn' : 'bg-danger inactive-btn'}'>${item.status == 1 ? 'Active' : 'Inactive'}</span></div>
