                        ...
                        <div class="card card-bordered card-stretch">
                           <div class="card-inner-group">
                              ...
                              <div class="card-inner p-0 text-center">
                                 <div class="nk-tb-list nk-tb-ulist" id="exam-list">
      ...
      $.ajax({
         ...
         if(data.total != 0)
         {
            ...
            <div class="nk-tb-item nk-tb-head">
               ...
               <div class="nk-tb-col"><span class="text-black fw-bold license-type" data-translate="Licence Type">Licence Type</span></div>
            ...
            data.data.forEach(item =>{
               $("#exam-list").append(`
                  <div class="nk-tb-item">
                     ...
                     <div class="nk-tb-col"><span class="badge badge-dim ${item.status ? 'bg-success active-btn' : 'bg-danger inactive-btn'}">${item.status ? 'Active' : 'Inactive'}</span></div>
