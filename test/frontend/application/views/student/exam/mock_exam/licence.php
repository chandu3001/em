      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="sub-licence"  class="col-form-label" style="font-weight: 600;">Sub License Type:</label>
             <select class="form-select js-select2 select2-hidden-accessible" name="sub-licence" id="sub-license" data-placeholder="Select Sub License" required data-msg="Sub License type is required">
            </select>
          </div>
      </div>
