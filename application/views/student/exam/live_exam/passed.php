          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-10 exam-type-fail">
                <a href="javascript:void(0)" onclick="backToLogin()"> <img class="" src="<?php echo base_url('assets/images/arrow.png') ?>" alt="Card image cap"> BACK </a>
                <!-- <a href="#"> <span class="time" style="float: right;">10m:30sec</span> </a> -->
                <?php include_once APPPATH . 'views/student/includes/main_header.php'; ?>

                <h1>SCORE CARD</h1>
                <div class="row score-card-fail">
    
                  <div class="card" style="width: 20rem;">
                    <div class="card-body user_img">
                      <h2 class="card-title">Congratulations
                     <br><span class="text-success">You passed <span id="exam_title"></span></span></h2>
                  ...
                  <div class="card" style="width: 30rem;">
                    <div class="card-body">
                      ...
                      <h5 class="card-title pass">Pass</h5>
                    </div>
