...
<div id="exam-begin" class="w-100 ps-4" style="display: none;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="mt-35 p-20 d-flex align-items-center flex-column col-md-3 que-details answer_video_alignment"
    ...
    <div class="container">
        <div class="mt-4 card card-body exam-details w-100"
            ...
            <div class="pagination-number">
                <div class="arrow page-left"><em class="icon ni ni-arrow-left"></em></div>
                
                <ul class="pagination options pagination-options"></ul>
                <div class="arrow page-right"><em class="icon ni ni-arrow-right"></em></div>
               </div>
            </div>
        </div>
    </div>
...
<!-- </div> -->
<button id="load-btn" class="d-none" onclick="htmlLoad();"></button>
