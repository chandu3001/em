   ...
   <div class="nk-app-root">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-end" aria-labelledby="filters_btn">
                                                ...
                                                <ul class="link-list-opt no-bdr pb-0">
                                                   ...
                                                   <li><a href="javascript:void(0)" onclick="getOverview(2)"><span
                                                            id="six-title" class="this-week">This Week</span></a>
                                                            ...
                                                            <li>
                                                               <form id='custom_date' class="">
                                                                  ...
                                                                  <div
                                                                     ...
                                                                     <input type="text" autocomplete="off" required placeholder="From date"
                                                                        name="fromdate" class="form-control from-date">

                                                                     <span class="to-label">To</span>

                                                                     <input type="text" autocomplete="off" required placeholder="To date"
                                                                        name="todate" class="form-control to-date">
      ...
      <script>
         ...
         $(function () {
            ...
            {
               $('.analytic-data-group.analytic-ov-group.g-3.justify-content-center').addClass('ltr')
            }
