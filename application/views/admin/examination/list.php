                           ...
                           <div class="card-inner-group">
                              <div class="card-inner position-relative card-tools-toggle">
                                                                  ...
                                                                  <form id="filter-form">
                                                                     ...
                                                                     <div class="col-6">
                                                                        <div class="form-group">
                                                                           ...
                                                                           <select name="result" class="form-select form-select-sm js-select2" data-placeholder="Select Status" id="sel-statuss">
                                                                              <option value=""></option>
                               ...
                               <div class="card-inner p-0 text-center">
                                    ...
                                    <div id="examination_results" class="nk-tb-list nk-tb-ulist">
            ...
            if(status)
            {
               ...
               data.data.forEach(item =>{
                   function getFormattedDate(date,time) {
                           ...
                           selectedDate = moment(item.started_at).format('DD-MM-YYYY hh:mm:ss A');
                     ...
                     resultData =`<button  type="button" class="btn btn-sm btn-danger inactive-btn arinactive-btn" style="border:none;padding:4px 17px;">Fail</button>`
                  ...
                  $("#examination_results").append(
                     ...
                     <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col tb-col-md ltr">${selectedDate}</div>
