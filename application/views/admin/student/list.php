...
<?php include_once APPPATH . 'views/admin/includes/header.php'; ?>
   ...
   <body class="nk-body npc-crypto bg-lighter has-sidebar " >
                        ...
                        <div class="nk-block-head nk-block-head-sm">
                           <div class="nk-block-between">
                              <div class="nk-block-head-content">
                                 <h3 class="nk-block-title page-title student-title" data-translate>Students</h3>
                                                         ...
                                                         <div class="dropdown">
                                                            ...
                                                            <div
                                                               ...
                                                               <form id="filter-form">
                                                                     ...
                                                                     <div class="row gx-6 gy-3">
                                                                        <div class="col-12">
                                                                           <div class="form-group">
                                                                              <label
                                                                                 class="overline-title overline-title-alt school-title" data-translate>School                                                                                 </label>
                                                                        ...
                                                                        <div class="col-6">
                                                                           <div class="form-group">
                                                                              ...
                                                                              <select name="status" id="Status"
                                                                                 class="form-select form-select-sm js-select2" data-placeholder="Status" data-sel-id="1">
                                                                                 <option value=""></option>
                                                                  ...
                                                                  <button type="reset" class="link p-0 text-primary" id="reset-filter" data-translate>Clear Filters</button>
                                                                  </div>
                                                               </form>
                                                            </div>
                                                         ...
                                                         <div class="dropdown">
                                                            ...
                                                            <div
                                                               ...
                                                               <ul class="link-check">
                                                                  ...
                                                                  <li ><a href="javascript:void(0)" style="justify-content: space-between;">10 <input checked onchange=" getStudentList(1,{pageSize:10})"  type="checkbox"  class="radio" value="1" name="fooby[1][]"  ></a></li>
                                                                  <li><a href="javascript:void(0)" style="justify-content: space-between;">20 <input onchange=" getStudentList(1,{pageSize:20})" type="checkbox" class="radio" value="1" name="fooby[1][]"  ></a></li>
                                                                  <li><a href="javascript:void(0)" style="justify-content: space-between;">50 <input onchange=" getStudentList(1,{pageSize:50})" type="checkbox"  class="radio" value="1" name="fooby[1][]" ></a></li>
                                                               </ul>
      ...
      function getFilterSchoolList() {
         $.ajax({
            type: "get",
            url: "https://dsms.technoiq.in/backend/api/auth/all_schools_list"
         }).done(({ errors, data }) => {
            if (!errors) {
               $("#school-filter").html(`<option value='' selected data-select2-id="2">Select school</option>`);

               data.result.forEach(item => {
                  $("#school-filter").append(`
                     <option value="${item.id} text-break">${item.name}</option>
                  `)
               })
            }
         })
      ...
      function getStudentList(pageNumber = page, option = {})
      {
         //showLoader()
         urlPage(pageNumber)
      ...
      page = pageNumber;
        ...
        params +=`page=${page}&sortby=${sortby}&pageSize=${pageSize}&${filters}&${query}`
         ...
         $.ajax({
            ...
            url: api_base_url+"students-by-school-id/0",
             beforeSend : function() {
                // $("#load-data").html('<img src="https://em.technoiq.in/test/frontend/assets/images/preloader.svg">');
             },
             data: params,
         }).done(({status, message, data})=>{
            if(status)
            {
               $("#total-record").text(`Total ${data.total} Students`)
               if(data.data.length > 0)
               {
                  ...
                  if (langCode == 2) {
                   $("#preloader2").show();
                     ...
                     $('.student-detail-list div span').text('');

                     $("#students_list,#students_list_pagination").hide();
                     setTimeout(function () {
                        setTimeout(function () {
                           $("#students_list,#students_list_pagination").show(); $("#load-data").html(''); $("#preloader2").hide();
                        }, 1000);
                     }, 500);
                  }
                  ...
                  <div class="nk-tb-item nk-tb-head student-detail-list">
                     ...
                     <div style="width:23.33%" class="nk-tb-col"><span class="text-black fw-bold student-title" data-translate="Student">Student</span></div>
                     <div style="width:23.33%" class="nk-tb-col"><span class="text-black fw-bold mobile" data-translate="Contact Number">Contact Number</span></div>
                     <div style="width:23.33%" class="nk-tb-col"><span class="text-black fw-bold school-name" data-translate="School Name">School Name</span></div>
                     <div style="width:15%" class="nk-tb-col tb-col-md"><span class="text-black fw-bold status-label" data-translate="Status">Status</span></div>
                     <div style="width:15%" class="nk-tb-col tb-col-sm"><span class="text-black fw-bold action" data-translate="Action">Action</span></div>
                  </div>
               `)
                  if(langCode == 2){
                  //$('.student-detail-list div span').text('');
               ...
               data.data.forEach(item => {
                  ...
                  <div class="nk-tb-item">
                     ...
                     <div style="width:23.33%" class="nk-tb-col text-center">
               
                      <span class="tb-lead text-break">${item.first_name_english} ${item.second_name_english}</span><span>Student ID: ${item.id}</span>
                        
                     </div>
                     
                     <div style="width:23.33%" class="nk-tb-col tb-col-md text-break">${item.phone}</div>
                     <div style="width:23.33%" class="nk-tb-col tb-col-md text-break">${item.school_name}</div> 
                     
                     <div style="width:15%" class="nk-tb-col"><span class='badge badge-dim ${item.status == 1 ? 'bg-success active-btn' : 'bg-danger inactive-btn arinactive-btn'}'>${item.status == 1 ? 'Active' : 'Inactive'}</span></div>
                     
                     
                     <div style="width:15%" class="nk-tb-col nk-tb-col-tools">
                        <ul class="">
                           <li>
                              <div class="drodown">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="link-list-opt no-bdr">
                                       <li><a href="<?php echo base_url('admin/students/view?student_id=');?>${item.id}"><em class="icon ni ni-eye"></em><span class="view-detail" data-translate="View Details">View Details</span></a></li>
                                    </ul>
                                 </div>
                              </div>
                           </li>
               ...
               {
                  $("#students_list").html(`<h4 class='text-center p-2'>No Students Available</h4>`)
      ...
      $("#sort_by").on("change", function(e){
           ...
           getStudentList(page,{sortBy: e.currentTarget.value})
      });
    ...
    $("#filter-form").on("submit", function(e){
        ...
        getStudentList(1,{filter: $(this).serialize()})
    })
    ...
    $("#reset-filter").on("click", function(e){
        ...
        e.preventDefault();
         ...
         $('#school-filter').select2('val','null');
        getStudentList(1, {filter: 'clearFilter'})
    })
    ...
    $("#studentSearchForm").on("submit", function(e){
        ...
        getStudentList(1,{q: $(this).serialize()})
    })
