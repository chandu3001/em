                                            ...
                                            <ul class="btn-toolbar gx-1">
                                                <li>
                                                    <div class="toggle-wrap">
                                                        ...
                                                        <ul class="btn-toolbar gx-1 m-0" id="fil-content">
    ...
    <script>
        ...
        function getQuestion(pageNumber = page, options = {})
        {
            ...
            $.ajax({
                ...
                data: filters
            }).done(({status, data, exam_name, license_name, sub_license_name, total_family, total_difficulty_levels, filter_data,default_language})=>{
                if(status)
                {
                    ...
                    if(data.data.length > 0)
                    {
                        ...
                        let options = '';
                            ...
                            var langCode = localStorage.getItem('language-type');
                             ...
                             if(default_language == 'English' && langCode == 2){
                                    dire = "direction:ltr!important;margin: 13px";
                                    queStyle=$('#fil-content').css('margin-right','865px');
                                                    ...
                                                    <div class="card-inner pe-0">
                                                        ...
                                                        <div class="nk-block">
                                                            ...
                                                            <div
                                                                ...
                                                                class="nk-block-head nk-block-head-sm nk-block-between questions" style="${dire}">
