   ...
   <script>
    ...
    if(totQue >= 1){
        ...
        jQuery.each(items, (index, item) => {
                ...
                if(student_data.language_name == 'English'){
                    dire = "direction:ltr!important";
                    elimiantoryStyle="float:left";
                    marksLeft = "float:left!important";
                    ansDateTime = "";
                    //marksLeft = "float:left!important";
                    ...
                    dire="";
                    marksLeft = "";
                    ansDateTime = "answersheet_date_time";
                    elimiantoryStyle="float:left";
                            ...
                            <div class="card-content">
                                <div class="card-inner">
                                    ${
                                        ...
                                        `
                                        <span style="color: orange;${elimiantoryStyle}"> NOTE:- Eliminatory Question</span>
                                        `
                                        :
                                        ''
                                    }
                                    ${ item.selected_option_id != "0" ? 
                                        `<span class="${ansDateTime}" style="float: right;color:#526484; font-weight:700"><span>Date:</span><span> ${moment(item.answered_time).format("DD-MMM-YYYY")}</span></span><br>
                                        <span class="${ansDateTime}" style="float: right;color:#526484; font-weight:700">Time: ${moment(item.answered_time).format("hh:mm:ss A")}</span><br>`
                                        :
                                        `<span class="${ansDateTime}" style="float: right;color:#526484; font-weight:700"><span></span></span><br>
                                        <span class="${ansDateTime}" style="float: right;color:#526484; font-weight:700"></span><br>`
                                    }
                                    

                                    <div class="nk-block" style="${dire}">
                                        ...
                                        <div class="question--mark clearfix">
                                            <span class="float-left" style="${marksLeft}"><b>Marks : </b>  ${item.marks}

                                            </span>
                                            <span class="float-right ${!gained ? 'text-danger' : 'text-info'} w-25" style="">
                                                <span class="d-flex align-items-center justify-content-end" style="${dire}"><b class="ml-2">Gained :  </b>  ${gained}  </span>
                                            </span>
                                        </div>
