...
<body class="nk-body bg-white npc-general pg-auth">
                            ...
                            <div class="cont">
                                <div class="login-container">
                                    <div class="login-container-content">
                                        <div class="borlogin">
                                            <div class="boxlo">
                                                <div class="logoschool"> <img src="https://em.technoiq.in/assets/images/logo2.jpeg" alt=""> <!-- <img src="./logoschool.jpeg"> -->
    ...
    <!-- JavaScript --> 
    <?php include_once APPPATH . 'views/school/includes/footer_scripts.php'; ?> <script>
        (function (NioApp, $) {
            'use strict';
            ...
            $('#loginForm').submit(function (e) {
                ...
                if ($('#loginForm').valid()) {
                    $.ajax({
                        url: formApiUrl('schooladmin/login'),
                        type: 'post',
                        dataType: 'json',
                        data: {
                        ...
                        if (response.status == true) {
                            ...
                            appModule.setData({
                                ...
                                'school_id': response.data.userdata.school_id,
                                ...
                                window.location.href = formUrl('school/dashboard');
                            });
