...
<script>
   ...
   function changeLanguage(val){
      $('html').hide();
      location.reload();
      $.cookie('lang', val, {path:'/school', domain: location.hostname});
      $.cookie('lang', val, {path:'/admin', domain: location.hostname});
      ...
      if(langCode == 2){
         ...
         $.ajax({
            ...
            {
               $('.en-sfilter,.en-examfilter').show();
               $('.ar-sfilter,.ar-examfilter').hide();
