                  ...
                  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                     <form id="templeteForm">
                        ...
                        <div class="mb-3 d-none" id="to-lang">
                           <label for="to" class="col-form-label" style="direction: ltr;">To:</label>
...
<script src="https://code.iconify.design/3/3.1.0/iconify.min.js"></script>
   <script>
      ...
      $(function () {
         ...
         languageText(langCode);
          ...
          if(langCode == 2){
               $('#difficulty_level').data('placeholder',"اختيار مستوى الصعوبة");
            }else{
               $('#difficulty_level').data('placeholder',"Select Difficulty Level");
            }
            ...
            if (status) {
               ...
               data.forEach(item => {
                  if (item.default_language == 1) {
                     ...
                     //console.log('lnag is'+item.language_name);
                     if(item.language_name == 'English'){
                        localStorage.setItem("defaultLangIs", 'english');

                        //$('.width_question').css('direction', 'ltr !important');
                     }
                     $("#from").val(item.id)
   ...
   <script>
        var defLang = localStorage.getItem("defaultLangIs");

         if(defLang == 'english'){
            console.log('here is edit1')
           $('#edit-question').css('direction','ltr !important');
         }
         ...
         $.ajax({
            ...
            if (status) {
               data.data.forEach((item) => {
                  ...
                  if(defLang == 'english'){
                     defStyle = "direction:ltr !important";
                  }else{
                     defStyle = "";
                  }
                  ...
                  $("#qlist").append(`
                        <div class="nk-tb-item details">
                           ...
                           <div class="nk-tb-col tb-col-md w-50 width_question" style="${defStyle}"><span>${item.question}</span></div>
                                    ...
                                    <div class="drodown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-end">
                                          <ul class="link-list-opt no-bdr">
                                             ...
                                             <li><a href="${base_url}school/question/language?id=${item.id}"><em class='icon'><span class="iconify" data-icon="tabler:message-language"></span></em><span class="language-title">Language</span></a></li>
                                          </ul>
                                       </div>
                                    </div>
                                 </li>
      ...
      function showQuestionPoolDetails(data) {
         ...
         optionsArr.forEach(item => {
            ...
            if (totWords > 55) {
               ...
               options += ` <div class="form-control-wrap col-md-10 my-2 row">
                              <div class="col-9">
         ...
         languageText(langCode);
            var defLang = localStorage.getItem("defaultLangIs");
                  if(defLang == 'english' && langCode == 2){
                     defStyle = "direction:ltr !important;text-align:right !important";
                     queDetTitle =  "تفاصيل السؤال";
                     queGroup = "مجموعة الأسئلة";
                     diffLevelTitle = "درجة الصعوبة";
                     marksTitle = "الدرجات";;
                     isElimTitle = "هل هذا سؤال رسوب فوري؟";
                     queTitle = "الاسئلة";
                     ansTitle="الاجوبة";
                  }else{
                     defStyle = "";
                     queDetTitle =  "Question Details";
                     queGroup = "Question Group";
                     diffLevelTitle = "Difficulty Level";
                     marksTitle = "Mark";
                     isElimTitle = "Is this an eliminatory question?";
                     queTitle = "Question";
                     ansTitle="Answers";

                  }
         document.body.innerHTML +=
            `<div class="modal-backdrop fade show view-ques"></div>
         <div class="modal fade show view-ques" id="view-ques" style="display: block;" tabindex="-1">
         <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
               <a style="cursor: pointer;" class="close" data-bs-dismiss="modal" aria-label="Close"><em class="icon ni ni-cross-sm"></em></a>
               <div class="modal-body modal-body-md">
                  <h5 class="modal-title que-details">${queDetTitle}</h5>
                  <form action="#" class="mt-2">
                     <div class="row g-gs" style="gap:1em">
                        
                        <div class="col-12">
                           <div class="form-group">
                             <label class="form-label que-family" for="full-name">${queGroup}</label>
                        ...
                        <div class="row gy-4" style="margin-top: 0px !important;">
                            <div class="col-sm-6 mt-0">
                                <div class="form-group">
                                    <label class="form-label diff-level" for="full-name">${diffLevelTitle}</label>
                                    <select class="form-select disable" data-search="on" data-select2-id="6" tabindex="-1" aria-hidden="true" name="family">
                            ...
                            <div class="col-sm-6 mt-0">
                                <div class="form-group">
                                     <label class="form-label marks" for="email-address">${marksTitle}</label>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group d-flex align-items-center gap-2">
                                <h5 class="form-label fw-bold mb-0 is-elim-que">${isElimTitle}</h5>
                        ...
                        <div class="col-12">
                           <div class="form-group">
                                <label class="form-label question oooo" for="email-address">${queTitle}</label>
                                 <div class="form-control-wrap">
                                    <textarea class="form-control disable" name="question" style="${defStyle}">${data.question}</textarea> 
                                 </div>
                           </div>
                        </div>
               ...
               `<div class="col-12">
                        ...
                        <div class="row" id="options--container">
                            ...
                            <div class="form-group">
                                 <label class="form-label answers" for="full-name">${ansTitle}</label>
                                 ${options}
                            </div>
                         </div>
                        </div>
         ...
         $("#view-ques .close").click(function () {
            $('.view-ques').remove();
            $('.btn-trigger').dropdown('hide')
         })
      }
      ...
      $(function () {
         ...
         $("#questionPoolAddForm").on("submit", function (e) {
            ...
            $('#questionPoolAddForm button:first').prop('disabled', true);
            ...
            if (questionPoolAddFormValidator.valid()) {
               ...
               $.ajax({
                  ...
                  if (res.status) {
                     $("#closeModal").click();
                     if(langCode == 2){
                      $('#questionPoolAddForm button:first').prop('disabled', false).text("اضافة سؤال")
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-3">
                        <div class="form-check form-control checkbox border-0" id="answer_checkbox" style="margin-top:7px !important">
                           ...
                           <label class="form-check-label correct" for="option${optionzCount}-answer">${crctLabel}</label>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <script>
      ...
      function getQuestionDetails(id) {
         ...
         $.ajax({
            ...
            if (res.status) {
               ...
               if(langCode == 2){
                  $("#editOptions").html(`<label class="form-label answers" for="full-name">الاجوبة</label>`);
                  crctLabel = "صحيح";
               }else{
                   $("#editOptions").html(`<label class="form-label answers" for="full-name">Answers</label>`);
                   crctLabel = "Correct";
               }
                     ...
                     <div id='eaftaOption' class="col-3 d-flex align-items-center">
                        <div class="form-control-wrap inner">
                           <div class="form-check form-control checkbox border-0" id="answer_checkbox" style="margin-top:7px !important">
                              ...
                              <label class="form-check-label correct" for="optioneafta-answer">${crctLabel}</label>
                           </div>
                        </div>
                     </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-3">
                              <div class="form-check form-control checkbox border-0" style="margin-top:7px !important">
                                 ...
                                 <label class="form-check-label correct" for="edit-option${editOptionzCount}-answer">${crctLabel}</label>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      function addOption() {
         ...
         if(langCode == 2){
         crctLabel = `<label class="form-check-label correct" for="edit-option${editOptionzCount}-answer">صحيح</label>`;

         }else{
                     crctLabel = `<label class="form-check-label correct" for="edit-option${editOptionzCount}-answer">Correct</label>`;
      ...
      document.getElementById("questionPoolEditForm").addEventListener("submit", function (e) {
         ...
         $("#questionPoolEditForm button:first").prop("disabled", true);
