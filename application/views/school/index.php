                                                                ...
                                                                <ul class="link-list-opt no-bdr pb-0">
                                                                    ...
                                                                    <li><a href="javascript:void(0)"
                                                                            onclick="getOverview(1)"><span
                                                                                class="three-title todays">Today</span></a>
                                                                    </li>

                                                                    <li><a href="javascript:void(0)"
                                                                            onclick="getOverview(2)"><span class="this-week" 
                                                                                >This Week</span></a>
                                                ...
                                                <div class="analytic-ov">
                                                    ...
                                                    <div class="analytic-data-group row text-center g-3 mb-3">
                                                        ...
                                                        <div class="analytic-data col-md-4">
                                                            ...
                                                            <div class="title" id="new-stud">New Students</div>
                                            ...
                                            <div class="card-inner">
                                                ...
                                                <div class="card-title-group align-start pb-3 g-2">
                                                    ...
                                                    <div class="card-title card-title-sm">
                                                        ...
                                                        <h6 class="title exm-stat">Exam Statistics</h6>
        ...
        <script>
            ...
            $(function () {
                ...
                $('[name="fromdate"], [name="todate"]').datepicker({
                    format: langCode == 2 ?'yyyy-mm-dd' : 'dd-mm-yyyy',
                    endDate: new Date()
                ...
                if (customDate) {
                    ...
                    switch (dates) {
                        ...
                        case 1:
                            ...
                            if(langCode == 2){
                                 $("#current_duration, .current_duration").html('اليوم');
                            }else{
                        ...
                        case 2:
                           ...
                           if(langCode == 2){
                                 $("#current_duration, .this-week").html("هذا الاسبوع");
                            }else{
                        ...
                        case 3:
                            ...
                            if(langCode == 2){
                                 $("#current_duration, .this-month").html("هذا الشهر");
                            }else{
                        ...
                        case 4:
                             ...
                             if(langCode == 2){
                                 $("#current_duration, #last-six").html("اخر ستة اشهر");
                            }else{
                        ...
                        case 5:
                            ...
                            if(langCode == 2){
                                $("#current_duration, #this-yr").html("هذا السنة");
                              }else{
                ...
                $.ajax({
                    ...
                    if (status) {
                        ...
                        if (data.labels.length > 0) {
                            ...
                            $("#fromdate, .fromdate").html(langCode == 2 ? moment(data.labels[0]).format('YYYY-MMM-DD') : data.labels[0])

                            $("#todate, .todate").html(langCode == 2 ? moment(data.labels[data.labels.length - 1]).format('YYYY-MMM-DD')  : data.labels[data.labels.length - 1])
                        ...
                        try {
                            ...
                            analyticOverview_chart != '' ? analyticOverview_chart.destroy() : '';

                            attended_chart != '' ? attended_chart.destroy() : '';

                            passed_chart != '' ? passed_chart.destroy() : '';

                            failed_chart != '' ? failed_chart.destroy() : '';
            ...
            $(function () {
                ...
                {
                $('.analytic-data-group.row.text-center.g-3.mb-3').addClass('ltr')
                }
